    ...
    return (
        <section className='my-10'>
            ...
            <div className="blogs">
                ...
                <div className="blog bg-indigo-50">
                    <h3 className='py-2 px-4 text-3xl font-semibold text-indigo-900'>Q2. How Does Context Api Work?</h3>
                    <p className='py-1 px-7 text-xl'>
                ...
                <div className="blog bg-indigo-50">
                    <h3 className='py-2 px-4 text-3xl font-semibold text-indigo-900'>Q3. What is "useRef"?</h3>
                    <p className='py-1 px-7 text-xl'>
